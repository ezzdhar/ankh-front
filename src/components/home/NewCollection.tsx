...
export function NewCollection({ image, title, link }: NewCollectionProps) {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#3A0F0E] aspect-[16/9] sm:aspect-auto sm:h-[calc(100vh-60px)]">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-6 text-center p-6 text-white z-10 animate-in fade-in slide-in-from-bottom-8 duration-1000 fill-mode-both">
